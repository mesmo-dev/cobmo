...
CREATE TABLE IF NOT EXISTS "building_scenarios" (
	...
	"time_end"	TEXT,
	"time_step"	TEXT,
	"thermal_sensible_storage_model_type"	TEXT
);
CREATE TABLE IF NOT EXISTS "building_thermal_sensible_storage_types" (
	"thermal_sensible_storage_type"	INTEGER
);
...
CREATE TABLE IF NOT EXISTS "building_zone_types" (
	...
	"hvac_tu_type"	TEXT,
	"zone_constraint_profile"	TEXT,
	"thermal_sensible_storage_type"	TEXT
);
COMMIT;
