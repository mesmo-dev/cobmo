...
class BuildingModel(object):
    ...
    def __init__(
        ...
        # Define timeseries.
        self.load_disturbance_timeseries(database_connection)
        self.load_electricity_price_timeseries(database_connection)
        self.define_output_constraint_timeseries(database_connection)
    ...
    def load_disturbance_timeseries(self, database_connection):
    ...
    def load_electricity_price_timeseries(self, database_connection):
    ...
    def define_output_constraint_timeseries(self, database_connection):
        """
